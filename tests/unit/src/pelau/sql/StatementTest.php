...
class StatementTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers proof\sql\Statement::fetch
    ...
    public function testFetch()
    {
        ...
        $this->assertEquals(0, $this->stmt->fetch($this->getMockForAbstractClass("proof\sql\FetchHandler")));

    }

    /**
     * @covers proof\sql\Statement::push
