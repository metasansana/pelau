...
class PDOStatementProxyTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers proof\sql\PDOStatementProxy::dofetch
     */
    public function testDofetch()
    {
        ...
        $this->assertEquals(1, $this->object->dofetch($con->query("SELECT * FROM users"),
                $this->getMock("proof\sql\TupleSet")));
    ...
    /**
     * @covers proof\sql\PDOStatementProxy::generateException
     * @expectedException proof\sql\SQLException
     */
