...
abstract class ConfiguredPDOConnection implements PDOConnection
{

    /**
     * A PDOConnector object this class wraps around.
     * @var proof\sql\PDOConnection $pcon
     * @access protected
     */
    protected $pcon;
     ...
     * @param \proof\sql\PDOConnection $pcon    The PDOConnector this connector wraps.
     */
    public function __construct(PDOConnection $pcon)
    {
